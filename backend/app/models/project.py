...
Used to persist project state on the server side, avoiding large data transfers between frontend API calls
"""
...
class ProjectStatus(str, Enum):
    ...
    GRAPH_BUILDING = "graph_building"    # Knowledge graph building
...
class Project:
    ...
    # Ontology info (populated after step 1 generation)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph info (populated after step 2 completion)
