    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are automatically chunked and processed via Zep to build the knowledge graph, extracting entities and relationships, and forming temporal memories and community summaries
          </p>
...
// Proceed to environment setup - create simulation and navigate
