  ...
  <div class="home-container">
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          <div class="tag-row">
            <span class="orange-tag">Simple & Versatile Collective Intelligence Engine</span>
          ...
          <div class="hero-desc">
            <p>
              Even with just a single paragraph of text, <span class="highlight-bold">MiroFish</span> based on the reality seeds within, <span class="highlight-orange">millions of Agents</span>can form a parallel world. Inject variables from a god's-eye view to find the <span class="highlight-code">"local optimum"</span>
            </p>
            <p class="slogan-text">
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <!-- Simulation workflow steps introduction (new section) -->
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dual-platform parallel simulation & auto-parsed prediction requirements & dynamically updated temporal memory</div>
                </div>
              </div>
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">ReportAgent with a rich toolset for deep interaction with the post-simulation environment</div>
                </div>
              </div>
              <div class="workflow-item">
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter simulation or prediction requirements in natural language (e.g., If Wuhan University issues a notice revoking a student's disciplinary action, what public sentiment will emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
// Start simulation - navigate immediately, API call handled in Process page
const startSimulation = () => {
  ...
  import('../store/pendingUpload.js').then(({ setPendingUpload }) => {
    ...
    // Navigate immediately to Process page (using special marker for new project)
    router.push({
      name: 'Process',
...
:root {
  ...
  --border: #E5E5E5;
  /* 
    Use Space Grotesk as the primary heading font, JetBrains Mono as code/label font
