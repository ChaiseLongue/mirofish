    ...
    <div class="main-content">
      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          <!-- Graph visualization (shown when data is available) -->
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, document chunks are processed via the Zep API to build the knowledge graph and extract entities and relationships
                </div>
              </div>
...
const renderGraph = () => {
  ...
  simulation.on('tick', () => {
    // Update all edge positions (visible line and transparent click areas)
